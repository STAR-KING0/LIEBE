...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: STAR-KING0 `))
            console.log(chalk.magenta(`${themeemoji} GITHUB: STAR-KING0 `))
            console.log(chalk.magenta(`${themeemoji} CHANNEL: https://whatsapp.com/channel/0029VaeW5Tw4yltQOYIO5E2D `))
